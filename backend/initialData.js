// Initial Data Seed for ProjectMonitor Backend
...
export const INITIAL_DATA = {
  users: [
    {
      ...
      title: "Dean of Academic Projects",
  ...
  projects: [
    {
      ...
      phaseIndex: 4,
      description: "An AI-powered computer vision mobile application that analyzes athletic biomechanics, sprint acceleration, and vertical jump metrics to discover grassroots sports talents.",
      membersCount: 4,
      members: [
  ...
  milestones: [
    ...
    },
    {
      ...
      status: "Pending",
      progress: 0,
      guideNotes: "Scheduled for live track & field trials with university sports club.",
      score: "-",
      weight: "15%"
    },
    {
  ...
  documents: [
    ...
    },
    {
      id: "DOC-303",
      projectId: "PRJ-101",
      name: "PRJ-101_System_Design_Document_SDD.pdf",
  ...
  systemLogs: [
    { timestamp: new Date().toISOString(), level: "INFO", message: "Database initialized with university capstone seed records" },
    { timestamp: new Date().toISOString(), level: "INFO", message: "REST API Router attached and listening on port 3000" }
  ]
};
